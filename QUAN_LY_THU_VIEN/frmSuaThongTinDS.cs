...
{
    public partial class frmSuaThongTinDS : Form
    {
        public frmSuaThongTinDS()
        {
            InitializeComponent();
        }
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            Con.Open();
                ...
                SqlCommand cmd1 = new SqlCommand(@" select
                                                    ...
                                                    thongtindausach.chuyennganh as 'Chuyên Ngành',
                                                    thongtindausach.sotrang as 'Số Trang',
                                                    thongtinloaisach.tenloai as 'Tên Loại Sách',
                                                    thongtinkesach.tenke as 'Tên Kệ Sách' 
                                                    from
                                                    thongtindausach,thongtincuonsach,ngonngu,thongtinkesach,thongtinloaisach,thongtinnhaxuatban
                                                    where
                                                    ...
                                                    and thongtindausach.maloai = thongtinloaisach.maloai
                                                    and thongtinloaisach.make = thongtinkesach.make 
        ...
        {
            if(tbxSoTrang.Text == "" || tbxNamXB.Text == "" || tbxTenCuonSach.Text == "" || tbxSoTrang.Text == null || tbxNamXB.Text == null || tbxTenCuonSach.Text == null )
            {
            }
            else
            {
                SqlConnection Con = Conn.GetCon();
            Con.Open();
                    SqlCommand cmd1 = new SqlCommand("update thongtindausach set tendausach = N'" + tbxTenCuonSach.Text + "', sotrang = '" + Convert.ToInt32(tbxSoTrang.Text) + "', namxuatban = '" + Convert.ToInt32(tbxNamXB.Text) + "' where madausach = '" + tbxMaDauSach.Text + "'", Con);
